    ...
    return (
        <SafeAreaView style={[style.area, {}]}>
            <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : null} >
               ...
               <Image source={require('../../../assets/image/Plantify.png')} resizeMode='stretch' style={{ height: 120, width: 120, marginTop: 20 }} />

                    <Text style={[style.s42, { marginTop: 10 }]}>Mọi người hãy sống cùng với cây xanh</Text>
                    ...
                    <View style={{ flex: 1, justifyContent: 'flex-end' }}>
                        ...
                        <TouchableOpacity onPress={()=>navigation.navigate('Signup')} style={[style.btno, { marginVertical: 15 ,marginBottom:20}]}>
                            <Text style={[style.s18, { color: Colors.primary }]}>Tạo tài khoản mới</Text>
                        </TouchableOpacity>
